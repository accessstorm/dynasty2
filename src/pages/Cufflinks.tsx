      ...
      <Container size="xl">
        <Box className="mb-16 text-center">
          ...
          <Text className={luxuryClasses.pageSubtitle}>
            Sophisticated details for the discerning gentleman
          </Text>
        </Box>
        ...
        >
          ...
          >
            ...
            <Text className="text-center max-w-xl mb-10 text-lg font-light tracking-wide text-gray-700 leading-relaxed">
              Our exclusive collection of premium cufflinks is being carefully curated and will be available shortly.
              Each pair is meticulously crafted with premium materials to add a touch of sophistication to your attire.
            </Text>
