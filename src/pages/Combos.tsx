...
const Combos = () => {
  ...
  // Color filters with counts for combos
  const colorFilters = [
    { color: 'black', label: 'Black', count: 6, colorCode: '#000000' },
    { color: 'navy', label: 'Navy Blue', count: 5, colorCode: '#172554' },
    ...
    { color: 'brown', label: 'Brown', count: 1, colorCode: '#8b4513' },
  ];
  ...
  return (
    <div className="py-8">
      ...
      <Container size="xl" className="mb-6 px-6 md:px-8">
        <Text component="h1" className="text-3xl font-serif text-center mb-2">Combos Collection</Text>
        <Text className="text-center text-gray-600 mb-8">
          Save with our elegant accessory combos
        </Text>
