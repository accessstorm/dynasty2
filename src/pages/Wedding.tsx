...
const Wedding = () => {
  ...
  // Color filters with counts for wedding collection
  const colorFilters = [
    { color: 'white', label: 'White', count: 12, colorCode: '#ffffff' },
    { color: 'grey', label: 'Grey', count: 8, colorCode: '#6b7280' },
  ...
  useEffect(() => {
    ...
    const { wedding } = StaticProductService.getStaticProducts();
    setProducts(wedding);
    ...
    applyFilters(initialPriceRange, initialColors, initialSort, wedding);
  }, [location.search]);
  ...
  return (
    <div className="py-8">
      ...
      <Container size="xl" className="mb-6 px-6 md:px-8">
        <Text component="h1" className="text-3xl font-serif text-center mb-2">Wedding Collection</Text>
        <Text className="text-center text-gray-600 mb-8">
          Elegant accessories for your special day
        </Text>
